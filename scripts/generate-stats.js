...
async function main() {
  ...
  <text x="24" y="46" font-family="'Courier New', monospace" font-size="13" fill="#00ff41" filter="url(#crtGlow)">root@shujahhhub:~$ ./fetch_stats.sh --live</text>
  ...
  <text x="24" y="192" font-family="'Courier New', monospace" font-size="12" fill="#00ff41" filter="url(#crtGlow)">root@shujahhhub:~$ <tspan class="cursor">█</tspan></text>
